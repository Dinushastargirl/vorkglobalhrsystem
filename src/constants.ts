...
export const MOCK_EMPLOYEES_DATA = [
  ...
  { branch: 'Headquarters', name: 'Jayaminda', email: 'msjayaminda@gmail.com', username: 'jayaminda', role: 'employee', salaryA: 50000, salaryB: 0, epf: 4000, advances: 0, cover: 0, intensive: 0, travelling: 0, net: 46000, joinDate: '2026-01-20' }
];

              ...
              <div className="h-[280px]">
                <ResponsiveContainer width="100%" height="100%">
                  <RadarChart cx="50%" cy="50%" outerRadius="80%" data={performanceData}>
                    ...
                    <Radar name="Score" dataKey="A" stroke="#d4af37" fill="#d4af37" fillOpacity={0.15} strokeWidth={3} />
                  </RadarChart>
                </ResponsiveContainer>
              </div>
            </div>
              ...
              <div className="h-[280px]">
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart data={xMetrics.history}>
                    ...
                    <Tooltip 
                      cursor={{ fill: '#1a1710', radius: 10 }}
                      contentStyle={{ borderRadius: '24px', border: 'none', backgroundColor: '#111113', boxShadow: '0 20px 25px -5px rgb(0 0 0 / 0.1)', padding: '12px 20px' }}
                    ...
                    <defs>
                      <linearGradient id="barGradient" x1="0" y1="0" x2="0" y2="1">
                        ...
                        <stop offset="100%" stopColor="#87671d" />
                      </linearGradient>
                    </defs>
                  </BarChart>
                </ResponsiveContainer>
